...
extension GraphComponent{
   ...
   func createRemainingDataLabel() -> UILabel{
      return with(.init()){
         ...
         let inscribedSquare = GraphComponent.squareInCircle(circleCenter: .init(x: circleRadius, y: circleRadius), radius: circleRadius)
   ...
   /**
    * Creates GraphGraphic
    */
   func createGraphGraphic() -> GraphGraphic{
