...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AnimationButtonLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC22AnimationButtonLibrary12CustomButton")
...
SWIFT_CLASS("_TtC22AnimationButtonLibrary15AnimationButton")
@interface AnimationButton : CustomButton
/// Boilerplate
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface AnimationButton (SWIFT_EXTENSION(AnimationButtonLibrary))
/// down
- (void)onTapDown;
/// up
- (void)onTapUp;
...
SWIFT_CLASS("_TtC22AnimationButtonLibrary14BackgroundView")
@interface BackgroundView : ConstraintView
...
@interface CustomButton (SWIFT_EXTENSION(AnimationButtonLibrary))
/// On tap down inside
